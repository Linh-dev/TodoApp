...
public class JwtProvider {
    ...
    public void init() {
        try {
            ...
            InputStream resourceAsStream = getClass().getResourceAsStream("/springtodo.jks");
    ...
    private PrivateKey getPrivateKey() {
        try {
            return (PrivateKey) keyStore.getKey("springtodo", "secret".toCharArray());
    ...
    private PublicKey getPublickey() {
        try {
            return keyStore.getCertificate("springtodo").getPublicKey();
